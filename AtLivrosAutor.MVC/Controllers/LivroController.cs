...
namespace AtLivrosAutor.MVC.Controllers
{
    public class LivroController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            ...
            try
            {
                ...
                using var response = await httpClient.GetAsync("https://localhost:7166/livros");
        ...
        public async Task<IActionResult> Add(LivroViewModel livroViewModel)
        {
            ...
            try
            {
                ...
                using var response = await httpClient.PostAsync("https://localhost:7166/livros", content);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> Detalhes(int id)
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", jwtToken);
                using var response = await httpClient.GetAsync($"https://localhost:7166/livros/{id}");
                response.EnsureSuccessStatusCode();
                var apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> Editar(int id, LivroViewModel livroViewModel)
        {
            ...
            try
            {
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", jwtToken);
                StringContent content = new StringContent(JsonConvert.SerializeObject(livroViewModel), Encoding.UTF8, "application/json");
                using var response = await httpClient.PutAsync($"https://localhost:7166/livros/{id}", content);
                response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> Deletar(int id)
        {
            ...
            try
            {
                ...
                using var response = await httpClient.DeleteAsync($"https://localhost:7166/livros/{id}");
                response.EnsureSuccessStatusCode();
        ...
        public async Task<IActionResult> SelecionarAutorLivro(int id)
        {
            ...
            {
                httpClient.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", jwtToken);
                using var response = await httpClient.GetAsync("https://localhost:7166/Autor");
                response.EnsureSuccessStatusCode();
                var apiResponse = await response.Content.ReadAsStringAsync();
        ...
        public async Task<IActionResult> VincularAutor(string autorId, int livroId)
        {
            ...
            try
            {
                ...
                using var response = await httpClient.PostAsync($"https://localhost:7166/livros/Autor/{livroId}", content);
                response.EnsureSuccessStatusCode();
