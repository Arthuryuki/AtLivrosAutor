...
namespace AtLivrosAutor.MVC.Controllers
{
    public class FuncionarioController : Controller
    {
        ...
        public async Task<IActionResult> Registro(FuncionarioViewModel funcionarioViewModel)
        {
            ...
            try
            {
                using var response = await httpClient.PostAsJsonAsync("https://localhost:7166/registro", funcionarioViewModel);
        ...
        public async Task<IActionResult> Login(FuncionarioViewModel funcionarioViewModel)
        {
            ...
            try
            {
                using var response = await httpClient.PostAsJsonAsync("https://localhost:7166/login", funcionarioViewModel);
